  ...
  <div>
    ...
    <div>
      ...
      <li v-for="object in unigene.pfam.pf">
        <tr>
            ...
            <td class="block">{{ object.s }}</td>
            <td class="block">{{ object.ev }}</td>
            <td class="block">{{ object.e }}</td>
            <td class="block">{{ object.n }}</td>
        </tr>
      </li>
      </div>
      <div v-else>No Pfam hit</div>
    </div>
    ...
    <div>
      ...
      <tr>
        <th class="block">n</th>
        <th class="block">ev</th>
        <th class="block">qc</th>
        <th class="block">sc</th>
        <th class="block">pi</th>
        <th class="block">tc</th>
        <th class="block">exact hit</th>
      </tr>
      <tr>
        <td class="block">{{ unigene.sprot_best.spb.n }}</td>
        <td class="block">{{ unigene.sprot_best.spb.ev }}</td>
        <td class="block">{{ unigene.sprot_best.spb.qc }}</td>
        <td class="block">{{ unigene.sprot_best.spb.sc }}</td>
        <td class="block">{{ unigene.sprot_best.spb.pi }}</td>
        <td class="block">{{ unigene.sprot_best.spb.tc }}</td>
        <td v-if="unigene.sprot_exact" class="block">{{ unigene.sprot_exact.spe }}</td><td v-else class="block">no exact hit</td>
      </tr>
      </div>
      <div v-else>No SwissProt hit</div>
    </div>
    <!--
    <div>
      SwissProt exact hit 
    ...
    <div>
      ...
      <tr>
        <td class="block">{{ unigene.trembl_best.trb.n }}</td>
        <td class="block">{{ unigene.trembl_best.trb.ev }}</td>
        <td class="block">{{ unigene.trembl_best.trb.qc }}</td>
        <td class="block">{{ unigene.trembl_best.trb.sc }}</td>
        <td class="block">{{ unigene.trembl_best.trb.pi }}</td>
        <td class="block">{{ unigene.trembl_best.trb.tc }}</td>
      </tr>
      </div>
      <div v-else>No Trembl hit</div>
    </div>
    <div>
      Neighbourhood
      <!--<div>{{ unigene.neighbour }}</div>-->
      <div  v-if="unigene.neighbour">
      <tr><td class="block">start</td><td class="block">end</td><td class="block">strand</td><th class="block"> orf_name </th></tr>
      <li v-for="object in unigene.neighbour.o">
        <tr><td class="block">{{object.s[0]}}</td><td class="block">{{object.s[1]}}</td><td class="block">{{object.s[2]}}</td><th class="block">{{object.g}}</th></tr>
      </li>
      </div>
      <div v-else>No Neighbourhood hit</div>
    </div>
  </div>
`}
