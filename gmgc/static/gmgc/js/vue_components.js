...
var ClusterForm = {
  ...
  <div class="row h-100 justify-content-center align-items-center">
	...
	<h5>Enter a GMGC cluster identifier (FORM B)</h5>
      </div>
      <div class="card-body">
	
	<div class="form-group">
	  <input v-model="cluster_id" class="form-control" id="cluster_id" name="cluster_id" placeholder="Cluster ID (xxx.xxx.xxx)"/>
	</div>
